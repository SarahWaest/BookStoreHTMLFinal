...
var BaseUri = "http://anbo-bookstorerest.azurewebsites.net/api/";
var contentElement = document.getElementById("content");
var element = document.getElementById("table_content");
var AllBooks;
var deleteBookelement = document.getElementById("deleteBook");
var newBookElement = document.getElementById("newBook");
var newBookinputFields;
var deleteBookinputFields;
...
GetAllBook();
function GetAllBook() {
    _node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0___default.a.get(BaseUri + "Books").then(function (response) {
        console.log("getting books... v4");
        setTimeout(function () { console.log("waited 5 sek"); }, 5000);
...
function deleteBook() {
    ...
    _node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0___default.a.delete(BaseUri + 'Books/' + id.value).then(function (respone) {
        GetAllBook();
    }).catch(function (error) {
...
function addBook() {
    ...
    var publisher = document.getElementById("inputpublisher");
    var price = document.getElementById("inputprice");
    _node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0___default.a.post(BaseUri + 'Books', {
        title: title.value,
        author: author.value,
